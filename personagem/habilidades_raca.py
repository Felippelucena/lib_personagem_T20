class Habilidades_Raca:
    def __init__(self, personagem):
        ...
        self.lista = {
            'anao': {'Conhecimento das Rochas':{'usar': self.conhecimento_das_rochas, 'tags':['passiva', 'anao']},
                     'Devagar e Sempre': {'usar': self.devagar_e_sempre, 'tags':['passiva','anao']},
                     'Duro como Pedra': {'usar': self.duro_como_pedra, 'tags':['passiva','anao']},
                     'Tradição de Heredrimm': {'usar': self.tradicao_de_heredrimm, 'tags':['passiva','anao']}
        }}
    ...
    def conhecimento_das_rochas(self):
        ...
        self.__personagem.tags['conhecimento_das_rochas'] = 'Visão no escuro'
        pericias = {
            'sobrevivencia': {'mod': 2, 'tags': ['conhecimento_das_rochas']},
            'percepcao':     {'mod': 2, 'tags': ['conhecimento_das_rochas']}
            }
        if self.__personagem.localizacao == 'subterraneo' and 'conhecimento_das_rochas' not in self.__personagem.pericias.lista['sobrevivencia']['tags']:
            self.__personagem.pericias.adicionar_mod(pericias)
            
        elif self.__personagem.localizacao != 'subterraneo' and 'conhecimento_das_rochas' in self.__personagem.pericias.lista['sobrevivencia']['tags']:
